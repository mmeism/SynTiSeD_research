...
class RNN_val(Disaggregator):
    ...
    def partial_fit(self,train_main,train_appliances,validate_main,validate_appliances,do_preprocessing=True,
            **load_kwargs):
